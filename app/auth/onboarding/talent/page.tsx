...
export default function TalentOnboardingPage() {
  ...
  const [skills] = useState(["Frontend", "Backend", "UI/UX Design", "Writing", "Digital Marketing"]);
    ...
    <div className="w-full max-w-2xl space-y-8">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative flex items-center">
          {/* Connecting Line */}
          <div className="absolute left-20 top-1/2 h-[1px] w-12 -translate-y-1/2 bg-blue-500/50"></div>
      ...
      <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); router.push("/auth/onboarding/success?role=talent"); }}>
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="text-xs font-semibold text-gray-400">First Name <span className="text-red-500">*</span></label>
            <input type="text" placeholder="First Name" className="h-12 w-full rounded-lg border border-white/10 bg-[#0E0C1D] px-4 text-sm text-white placeholder:text-gray-600 focus:border-blue-500 focus:outline-none" />
          </div>
          <div className="space-y-2">
            <label className="text-xs font-semibold text-gray-400">Last Name <span className="text-red-500">*</span></label>
            <input type="text" placeholder="Last Name" className="h-12 w-full rounded-lg border border-white/10 bg-[#0E0C1D] px-4 text-sm text-white placeholder:text-gray-600 focus:border-blue-500 focus:outline-none" />
          </div>
        </div>

        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="text-xs font-semibold text-gray-400">Username <span className="text-red-500">*</span></label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">@</span>
              <input type="text" placeholder="username" className="h-12 w-full rounded-lg border border-white/10 bg-[#0E0C1D] pl-8 pr-10 text-sm text-white placeholder:text-gray-600 focus:border-blue-500 focus:outline-none" />
              <div className="absolute right-4 top-1/2 -translate-y-1/2 text-green-500">
                {/* Valid icon placeholder */}
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
              </div>
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-xs font-semibold text-gray-400">Location <span className="text-red-500">*</span></label>
            <select className="h-12 w-full appearance-none rounded-lg border border-white/10 bg-[#0E0C1D] px-4 text-sm text-gray-400 focus:border-blue-500 focus:outline-none">
        ...
        <div className="space-y-2">
          <label className="text-xs font-semibold text-gray-400">Your Skills <span className="text-red-500">*</span></label>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center rounded-lg border border-white/10 bg-[#0E0C1D] overflow-hidden">
              ...
              <input type="text" placeholder="Enter your Github Username" className="h-12 w-full bg-transparent px-4 text-xs text-white placeholder:text-gray-600 focus:outline-none" />
            </div>
            <div className="flex items-center rounded-lg border border-white/10 bg-[#0E0C1D] overflow-hidden">
              <div className="flex h-12 w-12 items-center justify-center border-r border-white/10 bg-blue-500 text-white">
                {/* Discord Icon manually since lucide might not match exactly or user wants consistency */}
              ...
              <input type="text" placeholder="Enter your Discord Username" className="h-12 w-full bg-transparent px-4 text-xs text-white placeholder:text-gray-600 focus:outline-none" />
            </div>
            <div className="flex items-center rounded-lg border border-white/10 bg-[#0E0C1D] overflow-hidden">
              <div className="flex h-12 w-12 items-center justify-center border-r border-white/10 bg-blue-500 text-white">
