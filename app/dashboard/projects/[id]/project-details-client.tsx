      ...
      <div className='flex flex-col min-w-0 flex-1 w-full max-w-full gap-4 lg:gap-6 lg:pr-2 xl:pr-4 overflow-x-hidden'>
        ...
        <div className="flex items-center justify-between gap-4">
          <DetailsNavigation
            id={project.id}
            type='PROJECT'
            backLink={isOwner ? '/dashboard/owner/projects' : '/dashboard/projects'}
            backText={isOwner ? 'Back to My Projects' : 'Back to Projects'}
          ...
          {isOwner && (
            <div className="flex items-center gap-2">
              {project.txHash && (
                <a
                  href={`https://stellar.expert/explorer/testnet/tx/${project.txHash}`}
                  target="_blank"
              ...
              <Button size="sm" variant="outline" className="gap-2" onClick={() => setIsEditModalOpen(true)}>
        ...
        <div className='space-y-8 pb-20'>
          ...
          {/* Payment Milestones (Simple View) */}
          {milestones.length > 0 && (
