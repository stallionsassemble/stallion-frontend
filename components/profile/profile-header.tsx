  ...
  return (
    <div className="relative w-full mb-8">
      ...
      <div className="px-6 relative">
        <div className="flex flex-col md:flex-row items-start -mt-[100px] mb-4 gap-6">
          {/* Avatar */}
          <div className="relative h-[200px] w-[200px] rounded-full bg-background shrink-0">
            <Image
          ...
          {/* User Details */}
          <div className="flex-1 pt-[110px] md:pt-[110px] mb-2">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h1 className="text-3xl font-bold font-inter text-foreground">Tunde Ojo</h1>
        ...
        <div className="flex flex-wrap items-center gap-12 md:gap-20 mt-4 md:pl-[224px]">
          {/* Bounties */}
          <div className="flex flex-col items-center gap-1">
            <span className="text-[24px] font-bold font-inter text-foreground leading-none tracking-[-0.57px] text-center">24</span>
          ...
          {/* Earned */}
          <div className="flex flex-col items-center gap-1">
            <span className="text-[24px] font-bold font-inter text-[#0066FF] leading-none tracking-[-0.57px] text-center">$45,800</span>
          ...
          {/* Rating */}
          <div className="flex flex-col items-center gap-1">
            <span className="text-[24px] font-bold font-inter text-foreground leading-none tracking-[-0.57px] text-center">4.9</span>
          ...
          {/* Member Since */}
          <div className="flex flex-col items-center gap-1">
            <span className="text-[24px] font-bold font-inter text-foreground leading-none tracking-[-0.57px] text-center">March 2023</span>
