...
export function OwnerProfileTabs() {
  ...
  return (
    <div className="mb-4 overflow-x-auto">
      <div className="inline-flex items-center bg-muted-foreground/20 border border-white/5 backdrop-blur-sm w-full md:w-auto h-[44.58px] rounded-[11.76px] p-[4.41px] justify-between md:gap-4">
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              href={tab.href}
              className={cn(
                "flex items-center gap-2 px-3 py-1.5 rounded-[9px] font-inter text-[16px] font-normal transition-colors",
                isActive
